...
from your results?
In light of evaluating the extremely significant p value and the large effect size, we can safely conclude that the means between these two groups are different.
