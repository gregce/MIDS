...
# Exercise 1:
#------------------------------------------------
# Use the codes above and draw on one graph
# the time-series curve of the AR(1)/GARCH(1,1)
# model and the AR(1)/White Noise model.
# Make sure the graph is well-label and the axes
# are appropriate scaled. Write a few sentences
# to compare and constrast the two time series.
#------------------------------------------------
