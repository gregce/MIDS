...
#
# 1. Load the data call ex5.csv

# 2. Examine the basic structure of the data
#    How many observations are included in the dataset?
#    How many variables?
#    Are there any missing values?
#    What are the descriptive statistics associated with each
#    of the variables? Do they look "reasonable"?

# 3. Covert the electricity series (cbe$elec) into a time series
#    object using the ts() function
#    Examine the details of this series using the following functions
#    str(), summary(), quantile()

# 4. Plot the series
#    time-series plot, histogram, ACF, and PACF

# 5. List the first 10 observations of the original series,
#    first difference of the original series (using the diff() 
#    function), and the difference of the log of the original
#    series using the diff(log()) functions
#    Use summary to examine the descriptive statistics 
#    of the the differenced series and the differenced-log series

# 6. Plot the time-series plots of the original series,
#    the differenced series and the differenced-log series

# 7. Plot the ACF and PACF of the differenced series 
#    and the differenced-log series

# 8. Estimate the model using the Arima() function

# 9. Conduct model diagnostics using the estimate residuals
#    Plot the time-series graph, histogram, ACF, and PACF of the
#    residauls. Comment on the graphs
# Using Box.test to test the null hypothesis that the residual
# series is independence
# Try different lag values. Describe your observations

# 10. Conduct model performance evaluation by evaluating 
#     the in-sample fit of the model

# 11. Conduct a 12-step ahead out-of-sample forecast

# 12. Conduct back-testing by leaving out the last 12-observations of
#     the series and a 24-step ahead Out-of-Sample forecasting



z <- arima.sim(n = 250, list(order = c(3,1,2),
                             ar = c(0.5, 0.3, 0.1), 
                             ma = c(0.5,0.1)))
str(z)
summary(z)
