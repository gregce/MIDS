...
mod1 <- lm(postY ~ treat + affluence + preY, data=d)
...
mod2 <- lm(postY ~ treat + preY, data=d[d$female==0]) 
mod3 <- lm(postY ~ treat + preY, data=d[d$female==1]) 
...
mod4 <- lm(postY ~ treat + preY + female, data=d) 
mod5 <- lm(postY ~ treat + preY + female + treat*female, data=d) 
